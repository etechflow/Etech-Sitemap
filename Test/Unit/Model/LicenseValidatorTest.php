...
namespace Etechflow\Sitemap\Test\Unit\Model;
...
class LicenseValidatorTest extends TestCase
{
    ...
    public function testExplicitRevokeFlagWinsOverEverything(): void
    {
        ...
        $this->setConfig([
            LicenseValidator::XML_PATH_LICENSE_KEY => 'SP-live-abc123',
            LicenseValidator::XML_PATH_PORTAL_API_URL => self::PORTAL,
            'etechflow_sitemap/license/revoked' => '1',
        ]);
        $this->setCacheMiss();
    ...
    public function testForgedKeyAndAttackerControlledConfigCannotBypass(): void
    {
        ...
        $this->setConfig([
            ...
            LicenseValidator::XML_PATH_ISSUED_KEY                    => 'SP-i-made-this-up',
            'etechflow_sitemap/license/issued_domain'               => 'totally-pirated-store.com',
            'etechflow_sitemap/license/stripe_session_id'           => 'cs_fake_123',
            LicenseValidator::XML_PATH_ISSUED_AT                     => (string) time(),
            LicenseValidator::XML_PATH_IP_BLOCKED                    => '1',
        ]);
    ...
    public function testGraceFromPriorSuccessKeepsStorefrontLiveWhilePortalUnreachable(): void
    {
        ...
        $graceKey = 'etf_sitemap_lic_grace_' . md5($host . ':' . $key);
    ...
    public function testGraceDoesNotApplyToADifferentHost(): void
    {
        ...
        $goodGraceKey = 'etf_sitemap_lic_grace_' . md5('shop.example.com:SP-live-abc123');
        $this->cache->method('load')->willReturnCallback(
